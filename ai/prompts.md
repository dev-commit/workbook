...
- **`<img>`:** оставь как есть, только для `src` замени на путь вида `../@img/` + имя файла с расширением, как в исходном URL (только basename).
...
- **v-two-border** и **v-two** перепиши на **<v-two>**
