...
- В массив `const topics` добавь значение массива "ARR_MODULE" из текущего файла, причем:
  ...
  - если в children используется emoji, то НЕ НУЖНО добавлять это в формате "шаблонной строки" - нужно написать в подобном видео (фраза и emoji нужно брать из исходного файла): emoji.theory + 'Информация'
...
- Изображения должны быть закомментированы
...
- Таблица на HTML должны быть переписаны на таблицы в Markdown
