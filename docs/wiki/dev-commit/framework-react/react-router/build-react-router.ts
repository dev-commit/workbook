...
const topics: ISidebarTopics[] = [
  ...
  },
  {
    ...
    children: [
      ...
      ["api/useNavigate", getThemeMenu("accent", ["useNavigate()"]), "done"],
      ["api/useParams", getThemeMenu("accent", ["useParams()"]), "done"],
      ["api/useSearchParams", getThemeMenu("accent", ["useSearchParams()"])],
      ["api/useLocation", getThemeMenu("accent", ["useLocation()"])],
    ],
  },
  {
