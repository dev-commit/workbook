...
- В настоящее время Hook use доступен только в React’s canary and experimental channels
- Узнать больше
...
:::
    ...
    Позволяет читать значение ресурса, например Promise или context
    
источник данных, из которых вы хотите прочитать значение. Ресурсом может быть Promise или context
