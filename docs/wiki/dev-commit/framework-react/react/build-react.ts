...
const topics: ISidebarTopics[] = [
  ...
  },
  {
    ...
    children: [
      ...
      ["lifecycle/hook-constructor", getThemeMenu("method", ["constructor"])],
      [
        "lifecycle/hook-get-derived-state-from-props",
        getThemeMenu("method", ["getDerivedStateFromProps"]),
      ],
      [
        "lifecycle/hook-should-component-update",
        getThemeMenu("method", ["shouldComponentUpdate"]),
      ],
      ["lifecycle/hook-render", getThemeMenu("method", ["render"])],
      [
        "lifecycle/hook-get-snapshot-before-update",
        getThemeMenu("method", ["getSnapshotBeforeUpdate"]),
      ],
      [
        "lifecycle/hook-component-did-mount",
        getThemeMenu("method", ["componentDidMount"]),
      ],
      [
        "lifecycle/hook-component-did-update",
        getThemeMenu("method", ["componentDidUpdate"]),
      ],
      [
        "lifecycle/hook-component-will-unmount",
        getThemeMenu("method", ["componentWillUnmount"]),
      ],
      [
        "lifecycle/hook-get-derived-state-from-error",
        getThemeMenu("method", ["getDerivedStateFromError"]),
      ],
      [
        "lifecycle/hook-component-did-catch",
        getThemeMenu("method", ["componentDidCatch"]),
      ],
    ],
  },
  {
