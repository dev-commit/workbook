...
#### 1. **Физический** (physical) (Биты)

- Работа со средой передачи, сигналами и двоичными данными
- `USB` `Кабели`

#### 2. **Канальный** (data link) (Биты / Кадры)

- Физическая адресация
- `PPP` `IEEE 802.22` `Ethernet` `DSL` `ARP` `Сетевая карта`

#### 3. **Сетевой** (network) (Пакеты)

- Определение маршрута и логическая адресация
- **_`IPv4`_** **_`IPv6`_** `IPsec` `AppleTalk ICMP`

#### 4. **Транспортный** (transport) (Сегменты / Датаграммы)

- Прямая связь между конечными пунктами и надёжность
- **_`TCP`_** **_`UDP`_** `SCTP` `PORTS`

#### 5. **Сеансовый** (session) (Данные)
...
- **_`HTTP`_** **_`FTP`_** **_`POP3`_** **_`WebSocket`_**
