...
- 300 Multiply Choices - По указанному URI существует несколько вариантов предоставления ресурса по типу MIME, по языку или по другим характеристикам
- 301 Moved Permanantly - Запрошенный документ был окончательно перенесен на новый URI, указанный в поле Location заголовка
...
- 308 Permanant Redirect - Запрашиваемый ресурс был окончательно перенесен на новый URI, указанный в поле Location заголовка
...
- 403 Forbidden - Клиент не уполномочен совершать операции с запрошенным ресурсом
...
- 407 Proxy Authentication Required - Для доступа к запрашиваемому ресурсу требуется аутентификация для прокси-сервера
- 408 Request Timeout - Истекло время ожидания сервером передачи от клиента
...
- 413 Payload To Large - Слишком большой размер тела запроса
...
- 522 Connection Timed Out - CDN не удалось подключиться к веб-серверу
