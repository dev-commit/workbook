...
1. Пользователь заходит на сайт https://www.google.com/ с https
2. Браузер скачивает сертификат с google
3. Каждый сертификат подписан сертификатом верхнего уровня. Когда отдают сертификат, браузер смотрит сертифкат верхнего уровня для которого смотрится также сертифкат верхнего уровня
4. В браузера зашиты конревые сертифкаты. И когда мы дошли по цепочке сертификатов до него, значит корректно
