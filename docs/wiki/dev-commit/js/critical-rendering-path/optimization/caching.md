...
::: details Кэширование файлов и картинок
...
::: details Кэширование центра сертификации (Stamp центра сертификации)
...
::: details Кэширование страницы целиком
...
- _Минусы_: невозможность кэшировать страницы для авторизованного пользователя, либо пользователя, содержимое страницы которого зависит от текущих переменных пользователя.
...
::: details Кэширование результатов компиляции PHP-файлов
...
::: details Кэширование отдельных блоков страницы

- Сложный вид кэширования
- _Необходимо отслеживать_: состояние таблиц, состояние сессии пользователя, выключать ли кэширование при POST или GET запросах (http query), зависимость от текущего адреса, постоянство кэширования (при изменении предыдущих условий) или его динамическую подстройку.
- _Применение_: если нужно, уменьшить количество запросов к базе данных от реальных (авторизованных) пользователей
  :::

::: details Кэширование PHP на основе неразделяемых ресурсов
