...
const path = rootPath + "common2/blockchain/";
...
const topics: ISidebarTopics[] = [
  ...
  },
  {
    ...
    children: [
      ["application-web3/application-web3", emoji.theory + "Application Web 3.0"],
      ["application-web3/web3", getThemeMenu("method", ["Web3.js", "Ethers.js"])],
