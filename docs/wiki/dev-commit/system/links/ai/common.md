...
- [https://octopus.do/sitemap/generator](https://octopus.do/sitemap/generator) Octopus.do (отрисовывает структуру существующего сайта)
- [https://same.dev/](https://same.dev/) Same (копирование сайта)

## Управление компьютером

- [https://generalagents.com/ace/](https://generalagents.com/ace/) Ace Agent (Открывает приложения, работает в браузере, пишет письма и играет в игры. Управление по голосу)
