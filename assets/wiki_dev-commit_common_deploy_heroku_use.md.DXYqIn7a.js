import{_ as n,o as a,c as l,aw as o}from"./chunks/framework.DLufY-ao.js";const u=JSON.parse('{"title":"Код","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/dev-commit/common/deploy/heroku/use.md","filePath":"wiki/dev-commit/common/deploy/heroku/use.md"}'),p={name:"wiki/dev-commit/common/deploy/heroku/use.md"};function e(t,s,c,r,y,i){return a(),l("div",null,[...s[0]||(s[0]=[o(`<h1 id="код" tabindex="-1">Код <a class="header-anchor" href="#код" aria-label="Permalink to &quot;Код&quot;">​</a></h1><h2 id="простои-проект" tabindex="-1">Простой проект <a class="header-anchor" href="#простои-проект" aria-label="Permalink to &quot;Простой проект&quot;">​</a></h2><blockquote><p>package.json</p></blockquote><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki one-light vp-code" tabindex="0"><code><span class="line"><span style="color:#383A42;">{</span></span>
...
<span class="line"><span style="color:#383A42;">  }</span></span>
<span class="line"><span style="color:#383A42;">}</span></span></code></pre></div><blockquote><p>index.js</p></blockquote><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki one-light vp-code" tabindex="0"><code><span class="line"><span style="color:#A626A4;">const</span><span style="color:#986801;"> express</span><span style="color:#0184BC;"> =</span><span style="color:#4078F2;"> require</span><span style="color:#383A42;">(</span><span style="color:#50A14F;">&quot;express&quot;</span><span style="color:#383A42;">);</span></span>
...
<span class="line"><span style="color:#383A42;">});</span></span></code></pre></div><blockquote><p>.gitignore</p></blockquote><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-light vp-code" tabindex="0"><code><span class="line"><span style="color:#4078F2;">/node_modules</span></span></code></pre></div>`,8)])])}const d=n(p,[["render",e]]);export{u as __pageData,d as default};
