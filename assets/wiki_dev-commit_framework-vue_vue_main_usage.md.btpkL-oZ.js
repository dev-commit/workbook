import{_ as a,o as n,c as l,aw as p}from"./chunks/framework.DLufY-ao.js";const u=JSON.parse('{"title":"Использование","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/dev-commit/framework-vue/vue/main/usage.md","filePath":"wiki/dev-commit/framework-vue/vue/main/usage.md"}'),o={name:"wiki/dev-commit/framework-vue/vue/main/usage.md"};function e(t,s,c,r,y,i){return n(),l("div",null,[...s[0]||(s[0]=[p(`<h1 id="использование" tabindex="-1">Использование <a class="header-anchor" href="#использование" aria-label="Permalink to &quot;Использование&quot;">​</a></h1><h2 id="струтура-проекта" tabindex="-1">Струтура проекта <a class="header-anchor" href="#струтура-проекта" aria-label="Permalink to &quot;Струтура проекта&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki one-light vp-code" tabindex="0"><code><span class="line"><span>📂 src</span></span>
