import{_ as n,o as a,c as p,aw as l}from"./chunks/framework.DLufY-ao.js";const g=JSON.parse('{"title":"Spacing","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/dev-commit/framework-react/material-ui/styling/spacing.md","filePath":"wiki/dev-commit/framework-react/material-ui/styling/spacing.md"}'),o={name:"wiki/dev-commit/framework-react/material-ui/styling/spacing.md"};function c(t,s,e,i,y,A){return a(),p("div",null,[...s[0]||(s[0]=[l(`<h1 id="spacing" tabindex="-1">Spacing <a class="header-anchor" href="#spacing" aria-label="Permalink to &quot;Spacing&quot;">​</a></h1><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-light vp-code" tabindex="0"><code><span class="line"><span style="color:#4078F2;">spacing</span><span style="color:#383A42;">() == spacing(</span><span style="color:#4078F2;">1</span><span style="color:#383A42;">)</span></span></code></pre></div><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki one-light vp-code" tabindex="0"><code><span class="line"><span style="color:#4078F2;">spacing(0</span><span style="color:#383A42;">)     </span><span style="color:#A0A1A7;font-style:italic;"># 0px</span></span>
...
<span class="line"><span style="color:#4078F2;">spacing(14.75</span><span style="color:#383A42;">) </span><span style="color:#A0A1A7;font-style:italic;"># 118px</span></span></code></pre></div>`,3)])])}const f=n(o,[["render",c]]);export{g as __pageData,f as default};
