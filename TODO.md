...
### Новый Layout при перезагрузке страницы
- **Поведение**: удаляются все заголовки и секции с кодом
- **Элемент**: любой блок кода в "``` ```", возможно, в каких-то случаях и в "`code`"
- **Layout**: Новый Layout
- **Приложение** на GitHub
- **Когда**: При перезагрузке страницы или переходе по прямой ссылке
